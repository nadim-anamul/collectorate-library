<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-white leading-tight">{{ __('ui.issue_new_book') }}</h2>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-xl rounded-2xl overflow-hidden">
                ...
                <form action="{{ route('admin.loans.store') }}" method="POST" class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300">{{ __('ui.borrower') }} *</label>
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">{{ __('ui.only_approved_users_listed') }}</p>
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300">{{ __('ui.book') }} *</label>
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">{{ __('ui.unavailable_books_disabled') }}</p>
                        </div>
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300">{{ __('ui.issued_date') }} *</label>
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300">{{ __('ui.due_date') }} *</label>
                    ...
                    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4">
                        <p class="text-sm text-blue-800 dark:text-blue-200">{{ __('ui.due_date_defaults_14_days_from_issue') }}</p>
                    </div>
                    ...
                    <div class="flex items-center justify-between pt-2">
                        ...
                        <button class="inline-flex items-center px-8 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white rounded-xl transition duration-200 transform hover:scale-105 shadow-lg font-medium">{{ __('ui.issue_book') }}</button>
                    </div>
                </form>
            </div>
        </div>
