                            ...
                            <form method="GET" action="{{ route('admin.books.index') }}" class="p-4 space-y-6">
                                ...
                                <div>
                                    ...
                                    <select name="availability" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                        <option value="all" {{ !request('availability') || request('availability') == 'all' ? 'selected' : '' }}>{{ __('filters.all_books') }} (Default)</option>
                                ...
                                <!-- {{ __('filters.isbn') }} -->
                                <div>
                                    <label class="flex items-center text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{{ __('filters.isbn') }}</label>
                                    <input type="text" name="isbn" value="{{ request('isbn') }}" placeholder="{{ __('filters.isbn') }}" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 dark:bg-gray-700 dark:text-white" />
                                </div>
                                <!-- Sort -->
                                <div>
